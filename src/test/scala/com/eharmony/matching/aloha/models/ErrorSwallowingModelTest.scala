...
import com.eharmony.matching.aloha.semantics.{SemanticsUdfException, FunctionWithErrorProducingSemantics}
...
import com.eharmony.matching.aloha.ex.SchrodingerException
...
class ErrorSwallowingModelTest {
    @Test def testExThrownInGetMessage() {
        ...
        assertEquals("1st error", "com.eharmony.matching.aloha.ex.SchrodingerException thrown in model 0.", s.getError.getMessages(0))
    ...
    @Test def testSemanticsUDFException() {
        ...
        assertEquals("1st error", "com.eharmony.matching.aloha.semantics.SemanticsUdfException thrown in model 0.", s.getError.getMessages(0))
