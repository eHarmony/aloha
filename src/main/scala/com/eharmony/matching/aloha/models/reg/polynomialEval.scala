...
/** Provides a method to evaluate polynomials given an input.  Default implementation of
  * [[com.eharmony.matching.aloha.models.reg.PolynomialEvaluationAlgo]].
  * @param value
  * @param descendants
  */
...
object PolynomialEvaluator {
    ...
    class PolynomialEvaluatorBuilder extends mutable.Builder[PathAndWeight, PolynomialEvaluator] {
        ...
        /** Add first order terms.
          ...
          * @param n the size of x passed to [[com.eharmony.matching.aloha.models.reg.PolynomialEvaluationAlgo]].at
          * @return
          */
        ...
        /** The builder method passed to [[com.eharmony.matching.aloha.models.tree.Tree]] object's apply method.
          */
        ...
        /** Turn the tree represented by this structure into a table-based structure with a lookup map so that we
          * can use the [[com.eharmony.matching.aloha.models.tree.Tree]] objects apply method to build an immutable
          * version.
          * @return
          */
