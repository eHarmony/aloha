package com.eharmony.matching.aloha.io.multiple

import com.eharmony.matching.aloha.io.NonFileReadable
import com.eharmony.matching.aloha.io.sources.{ReaderReadableSource, InputStreamReadableSource, StringReadableSource, NonFileReadableLikeSource}

/** Allows us to read in bulk from non-file-oriented resources by delegating to
  * [[com.eharmony.matching.aloha.io.NonFileReadable]].
  *
