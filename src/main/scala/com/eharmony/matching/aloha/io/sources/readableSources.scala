...
/** An object from which we can read in bulk using a [[com.eharmony.matching.aloha.io.FileReadable]].
  */
sealed trait FileReadableLikeSource extends ReadableSource

/** An object from which we can read in bulk using a [[com.eharmony.matching.aloha.io.NonFileReadable]].
  */
