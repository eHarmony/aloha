...
/** The string values here match the function names in CsvLine.  This is important that the name passed to
  ...
  * [[com.eharmony.aloha.semantics.compiled.plugin.csv.CsvLine]].
  * @author R. M. Deak
  */
object CsvTypes extends Enumeration {
    ...
    /** Like withName but gives back [[com.eharmony.aloha.semantics.compiled.plugin.csv.CsvTypes.CsvType]]
      * rather than [[com.eharmony.aloha.semantics.compiled.plugin.csv.CsvTypes#Value]]
...
//    }
//
//    /** Like withName but gives back [[com.eharmony.aloha.semantics.compiled.plugin.csv.CsvTypes.CsvTypes]]
//      * rather than [[com.eharmony.aloha.semantics.compiled.plugin.csv.CsvTypes#Value]]
//      * @param s a string representation of the type.
//      * @return
//      */
