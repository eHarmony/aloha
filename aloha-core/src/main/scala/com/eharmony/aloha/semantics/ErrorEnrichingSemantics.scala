...
import com.eharmony.aloha.semantics.func.{EnrichedErrorGenAggFunc, GenAggFunc}
...
/** User-defined functions used in feature specifications can cause models to throw undesirable exceptions.  This
  ...
  * [[com.eharmony.aloha.semantics.SemanticsUdfException]] and rethrown.  This has the distinct advantage of
  ...
  * [[com.eharmony.aloha.semantics.Semantics]]\[Xyz\].  We can recast the errors by doing
  * {{{
...
trait ErrorEnrichingSemantics[A] extends Semantics[A] {
    ...
    /** Only when this function returns true will the functions produced by this semantics be wrapped in a
      * [[com.eharmony.aloha.semantics.func.EnrichedErrorGenAggFunc]].  The default for this function is true.
    ...
    /** Create a function from A to B.  If ''provideSemanticsUdfException'' is ''false'' or the generated function is
      * is [[com.eharmony.aloha.semantics.func.EnrichedErrorGenAggFunc]] return the function; otherwise,
      * return the function wrapped in an [[com.eharmony.aloha.semantics.func.EnrichedErrorGenAggFunc]].
      * [[com.eharmony.aloha.semantics.func.GenAggFunc]] produced by the underlying semantics.
