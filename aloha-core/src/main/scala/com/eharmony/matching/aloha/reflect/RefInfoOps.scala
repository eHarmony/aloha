...
sealed trait RefInfoOps[RefInfoType[_]] {
  ...
  /**
   * Get reflection information about [[com.eharmony.matching.aloha.semantics.func.GenAggFunc]]
   * @tparam A function input type
   * @tparam B function output type
   * @return reflection information about [[com.eharmony.matching.aloha.semantics.func.GenAggFunc]]
   */
