...
/** The type of threading model to use for compilation within the
  * [[com.eharmony.matching.aloha.semantics.compiled.compiler.TwitterEvalCompiler]].
  */
sealed trait EvalThreadingModel

/** Creates a single instance of com.twitter.util.Eval within the
  * [[com.eharmony.matching.aloha.semantics.compiled.compiler.TwitterEvalCompiler]] instance.
  */
