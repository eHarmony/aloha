...
/**
  ...
  */
case class HierarchicalConstantModel[T <: TypeCtor, -A, +SN, N](modelId: ModelIdentity, tc: T, constant: N, auditor: Auditor[ModelIdentity, T, N])(val sub: Model[A, T#TC[SN]])
