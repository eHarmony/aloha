...
class FactoryImportedModelTest {
    ...
    def test1CycleDetected() {
        ModelFactory(ErrorModel.parser).
            ...
            fromResource("com/eharmony/aloha/factory/cycle1_A.json").
            get
    }
    ...
    def test2CycleDetected() {
        ModelFactory(ErrorModel.parser).
            toTypedFactory[Any, Int].
            fromResource("com/eharmony/aloha/factory/cycle2_A.json").
            get
    }
    ...
    def test3CycleDetected() {
        ModelFactory(ErrorModel.parser).
            toTypedFactory[Any, Int].
            fromResource("com/eharmony/aloha/factory/cycle3_A.json").
            get
    }
    ...
    @Test def test1LevelSuccessDefault() {
        val m = ModelFactory(ConstantModel.parser).
            toTypedFactory[Any, Int].
            fromResource("com/eharmony/aloha/factory/success_1_level_default.json").
            get
    ...
    @Test def test1LevelSuccessVfs1() {
        val m = ModelFactory(ConstantModel.parser).
            toTypedFactory[Any, Int].
            fromResource("com/eharmony/aloha/factory/success_1_level_vfs1.json").
            get
    ...
    @Test def test1LevelSuccessVfs2() {
        val m = ModelFactory(ConstantModel.parser).
            toTypedFactory[Any, Int].
            fromResource("com/eharmony/aloha/factory/success_1_level_vfs2.json").
            get
    ...
    @Test def test1LevelSuccessFile() {
        val m = ModelFactory(ConstantModel.parser).
            toTypedFactory[Any, Int].
            fromResource("com/eharmony/aloha/factory/success_1_level_file.json").
            get
    ...
    @Test def test1LevelApproprivateFailureWithDefaultProtocol() {
        try {
            ModelFactory(ErrorModel.parser).
                toTypedFactory[Any, Int].
                fromResource("com/eharmony/aloha/factory/bad_reference_default.json").
                get
            fail()
        }
        catch {
    ...
    @Test def test1LevelApproprivateFailureWithVfs1() {
        try {
            ModelFactory(ErrorModel.parser).
                toTypedFactory[Any, Int].
                fromResource("com/eharmony/aloha/factory/bad_reference_vfs1.json").
                get
            fail()
        }
        catch {
    ...
    @Test def test1LevelApproprivateFailureWithVfs2() {
        try {
            ModelFactory(ErrorModel.parser).
                toTypedFactory[Any, Int].
                fromResource("com/eharmony/aloha/factory/bad_reference_vfs2.json").
                get
            fail()
        }
        catch {
    ...
    @Test def test1LevelApproprivateFailureWithFile() {
        try {
            ModelFactory(ErrorModel.parser).
                toTypedFactory[Any, Int].
                fromResource("com/eharmony/aloha/factory/bad_reference_file.json").
                get
            fail()
        }
        catch {
