...
import com.eharmony.aloha.io.sources.ReadableSourceConverters.stringToStringReadableConverter
...
import com.eharmony.aloha.algebra.tries.TryScalazMonad   // Provides Applicative type class for Try
