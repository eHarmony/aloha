package com.eharmony.aloha.score.proto.conversions.rich
...
import com.eharmony.aloha.score.proto.conversions.{BasicTypeScoreConversions, RelaxedConversions, StrictConversions}
import com.eharmony.aloha.score.proto.order.Orderings._
...
trait RichScoreLike {
    ...
    /** Provides access the functionality available in [[com.eharmony.aloha.score.proto.conversions.StrictConversions]].
    ...
    /** Provides access the functionality available in [[com.eharmony.aloha.score.proto.conversions.RelaxedConversions]].
