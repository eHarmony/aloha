...
public class FlatScore extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8331853885625348556L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"FlatScore\",\"namespace\":\"com.eharmony.aloha.audit.impl.avro\",\"fields\":[{\"name\":\"model\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"ModelId\",\"fields\":[{\"name\":\"id\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"name\",\"type\":[\"null\",\"string\"],\"default\":null}]}],\"default\":null},{\"name\":\"value\",\"type\":[\"null\",\"boolean\",\"int\",\"long\",\"float\",\"double\",\"string\",{\"type\":\"array\",\"items\":[\"boolean\",\"int\",\"long\",\"float\",\"double\",\"string\"]}],\"default\":null},{\"name\":\"subvalues\",\"type\":[{\"type\":\"array\",\"items\":\"int\"},\"null\"],\"doc\":\"Each value in subvalues is an index in the FlatScoreList.scores.\\n     E.g., 1 means the FlatScore at index 1 in FlatScoreList.scores is a subvalue of this FlatScore.\",\"default\":[]},{\"name\":\"errorMsgs\",\"type\":[{\"type\":\"array\",\"items\":\"string\"},\"null\"],\"default\":[]},{\"name\":\"missingVarNames\",\"type\":[{\"type\":\"array\",\"items\":\"string\"},\"null\"],\"default\":[]},{\"name\":\"prob\",\"type\":[\"null\",\"float\"],\"default\":null}]}");
  ...
  @Deprecated public java.util.List<java.lang.Integer> subvalues;
   ...
   * @param subvalues Each value in subvalues is an index in the FlatScoreList.scores.
     E.g., 1 means the FlatScore at index 1 in FlatScoreList.scores is a subvalue of this FlatScore.
   ...
   */
  public FlatScore(com.eharmony.aloha.audit.impl.avro.ModelId model, java.lang.Object value, java.util.List<java.lang.Integer> subvalues, java.util.List<java.lang.CharSequence> errorMsgs, java.util.List<java.lang.CharSequence> missingVarNames, java.lang.Float prob) {
    this.model = model;
    this.value = value;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: subvalues = (java.util.List<java.lang.Integer>)value$; break;
   ...
   * @return Each value in subvalues is an index in the FlatScoreList.scores.
     E.g., 1 means the FlatScore at index 1 in FlatScoreList.scores is a subvalue of this FlatScore.
   */
  public java.util.List<java.lang.Integer> getSubvalues() {
    return subvalues;
  }
   ...
   * @param value the value to set.
   */
  public void setSubvalues(java.util.List<java.lang.Integer> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FlatScore>
    ...
    /** Each value in subvalues is an index in the FlatScoreList.scores.
     E.g., 1 means the FlatScore at index 1 in FlatScoreList.scores is a subvalue of this FlatScore. */
    private java.util.List<java.lang.Integer> subvalues;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eharmony.aloha.audit.impl.avro.FlatScore.Builder setSubvalues(java.util.List<java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.eharmony.aloha.audit.impl.avro.FlatScore.Builder clearSubvalues() {
      subvalues = null;
    ...
    public FlatScore build() {
      try {
        ...
        record.subvalues = fieldSetFlags()[2] ? this.subvalues : (java.util.List<java.lang.Integer>) defaultValue(fields()[2]);
